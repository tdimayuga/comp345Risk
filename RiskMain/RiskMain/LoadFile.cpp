...
bool LoadFile::load(string fileType, string fileName)
{
	...
	{
		this->loadAdapter = new LoadAdapter(fileType);
		return this->loadAdapter->load(fileType, fileName);
	}
	else
	{
